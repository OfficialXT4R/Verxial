...
HXDLIN( 283)				 ::hscript::Expr e1 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 283)								::Array< ::Dynamic> _g2 = t->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
...
HXLINE( 283)						return false;
            			...
            			break;
            			case (int)4: {
HXLINE( 281)				::Array< ::Dynamic> _g3 = _g->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 281)				return true;
            			}
            			break;
            			case (int)6: {
HXLINE( 285)				::String _g4 = _g->_hx_getString(0);
HXDLIN( 285)				 ::hscript::Expr _g5 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 285)				 ::hscript::Expr e2 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 285)				return this->isBlock(e2);
            			}
            			break;
            			case (int)7: {
HXLINE( 286)				::String _g6 = _g->_hx_getString(0);
HXDLIN( 286)				bool prefix = _g->_hx_getBool(1);
HXDLIN( 286)				 ::hscript::Expr e3 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 286)					return false;
            			...
            			break;
            			case (int)9: {
HXLINE( 284)				 ::hscript::Expr _g7 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 284)				 ::hscript::Expr e11 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 284)				 ::hscript::Expr e21 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 284)					return this->isBlock(e11);
            			...
            			break;
            			case (int)10: {
HXLINE( 287)				 ::hscript::Expr _g8 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 287)				 ::hscript::Expr e4 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 287)				return this->isBlock(e4);
            			}
            			break;
            			case (int)11: {
HXLINE( 289)				::String _g9 = _g->_hx_getString(0);
HXDLIN( 289)				 ::hscript::Expr _g10 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 289)				 ::hscript::Expr e5 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 289)				return this->isBlock(e5);
            			}
            			break;
            			case (int)14: {
HXLINE( 282)				::Array< ::Dynamic> _g11 = _g->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 282)				::String _g12 = _g->_hx_getString(2);
HXDLIN( 282)				 ::hscript::CType _g13 = _g->_hx_getObject(3).StaticCast<  ::hscript::CType >();
HXDLIN( 282)				 ::hscript::Expr e6 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 282)				return this->isBlock(e6);
            			}
            			break;
            			case (int)15: {
HXLINE( 290)				 ::hscript::Expr e7 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 290)					return false;
            			...
            			break;
            			case (int)20: {
HXLINE( 291)				 ::hscript::Expr _g14 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 291)				::String _g15 = _g->_hx_getString(1);
HXDLIN( 291)				 ::hscript::CType _g16 = _g->_hx_getObject(2).StaticCast<  ::hscript::CType >();
HXDLIN( 291)				 ::hscript::Expr e8 = _g->_hx_getObject(3).StaticCast<  ::hscript::Expr >();
HXDLIN( 291)				return this->isBlock(e8);
            			}
            			break;
            			case (int)21: {
HXLINE( 281)				::Array< ::Dynamic> _g17 = _g->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 281)				return true;
            			}
            			break;
            			case (int)23: {
HXLINE( 281)				 ::hscript::Expr _g18 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 281)				::Array< ::Dynamic> _g19 = _g->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 281)				 ::hscript::Expr _g20 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 281)				return true;
            			}
            			break;
            			case (int)24: {
HXLINE( 288)				 ::hscript::Expr _g21 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 288)				 ::hscript::Expr e9 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 288)				return this->isBlock(e9);
            			}
            			break;
            			case (int)25: {
HXLINE( 292)				::String _g22 = _g->_hx_getString(0);
HXDLIN( 292)				::Array< ::Dynamic> _g23 = _g->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 292)				 ::hscript::Expr e10 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 303)					 ::hscript::Expr _g3 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 309)			_hx_tmp2 = ::hx::IsPointerNotEq( tk,::hscript::Token_obj::TEof_dyn() );
            		}
            		else {
...
HXLINE( 370)								return this->parseExprNext(::hscript::Expr_obj::EParent(e2));
            							...
            							break;
            							case (int)9: {
HXLINE( 385)								 ::hscript::Expr _g2 = e2;
HXDLIN( 385)								if ((_g2->_hx_getIndex() == 1)) {
HXLINE( 386)									::String v = _g2->_hx_getString(0);
...
HXLINE( 376)											return this->parseExprNext(::hscript::Expr_obj::ECheckType(e2,t));
            										...
            										break;
            										case (int)9: {
HXLINE( 378)											 ::hscript::Expr _g3 = e2;
HXDLIN( 378)											if ((_g3->_hx_getIndex() == 1)) {
HXLINE( 379)												::String v1 = _g3->_hx_getString(0);
...
HXLINE( 409)										::String _g4 = c1->_hx_getString(0);
HXDLIN( 409)										{
...
HXDLIN( 422)									_this4->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this4->head);
            							...
            							break;
            							case (int)2: {
HXLINE( 397)								::String _g5 = tk->_hx_getString(0);
HXDLIN( 397)								{
...
HXLINE( 430)								_hx_tmp1 = ::hx::IsPointerEq( tk,::hscript::Token_obj::TEof_dyn() );
            							}
            							else {
...
HXLINE( 453)								_hx_tmp2 = ::hx::IsPointerNotEq( tk,::hscript::Token_obj::TEof_dyn() );
            							}
            							else {
...
HXLINE( 461)						 ::hscript::Expr _g6 = a1->__get(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 461)						switch((int)(_g6->_hx_getIndex())){
            							case (int)10: {
HXLINE( 462)								 ::hscript::Expr _g7 = _g6->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 462)								 ::hscript::Expr _g8 = _g6->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXLINE( 469)								return this->parseExprNext(e3);
            							...
            							break;
            							case (int)11: {
HXLINE( 462)								::String _g9 = _g6->_hx_getString(0);
HXDLIN( 462)								 ::hscript::Expr _g10 = _g6->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 462)								 ::hscript::Expr _g11 = _g6->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 469)								return this->parseExprNext(e4);
            							...
            							break;
            							case (int)24: {
HXLINE( 462)								 ::hscript::Expr _g12 = _g6->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 462)								 ::hscript::Expr _g13 = _g6->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 496)			if (!(__hxcpp_enum_eq(t1,::hscript::Token_obj::TOp(HX_("->",71,27,00,00))))) {
...
HXLINE( 536)					 ::hscript::Expr e1 = _g->__get(0).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 534)				 ::hscript::Expr e21 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 527)					edef = ::hscript::Expr_obj::ECall(::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            			...
            			break;
            			case (int)10: {
HXLINE( 530)				 ::hscript::Expr cond1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 530)				 ::hscript::Expr e22 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 528)				 ::hscript::Expr e23 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 527)				edef = ::hscript::Expr_obj::EFor(v,it,this->mapCompr(tmp,e23));
            			}
            			break;
            			case (int)24: {
HXLINE( 532)				 ::hscript::Expr cond2 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 532)				 ::hscript::Expr e24 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXLINE( 549)		 ::hscript::Expr _g = e;
HXDLIN( 549)		switch((int)(_g->_hx_getIndex())){
            			case (int)6: {
HXLINE( 550)				::String bop = _g->_hx_getString(0);
HXDLIN( 550)				 ::hscript::Expr e1 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 550)				 ::hscript::Expr e2 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 550)				return ::hscript::Expr_obj::EBinop(bop,this->makeUnop(op,e1),e2);
            			}
            			break;
            			case (int)22: {
HXLINE( 551)				 ::hscript::Expr e11 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 551)				 ::hscript::Expr e21 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 551)				 ::hscript::Expr e3 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 559)		 ::hscript::Expr _g = e;
HXDLIN( 559)		switch((int)(_g->_hx_getIndex())){
            			case (int)6: {
HXLINE( 560)				::String op2 = _g->_hx_getString(0);
HXDLIN( 560)				 ::hscript::Expr e2 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 560)				 ::hscript::Expr e3 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 564)					return ::hscript::Expr_obj::EBinop(op,e1,e);
            			...
            			break;
            			case (int)22: {
HXLINE( 565)				 ::hscript::Expr e21 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 565)				 ::hscript::Expr e31 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 565)				 ::hscript::Expr e4 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 581)				if (::hx::IsPointerNotEq( t3,::hscript::Token_obj::TPOpen_dyn() )) {
...
HXDLIN( 583)				if (::hx::IsPointerNotEq( t4,::hscript::Token_obj::TPClose_dyn() )) {
...
HXLINE( 588)			if (::hx::IsPointerEq( tk2,::hscript::Token_obj::TSemicolon_dyn() )) {
HXLINE( 589)				semic = true;
HXLINE( 590)				tk2 = this->token();
            			}
HXLINE( 592)			if (__hxcpp_enum_eq(tk2,::hscript::Token_obj::TId(HX_("else",b9,e4,14,43)))) {
...
HXDLIN( 653)			if (::hx::IsPointerEq( tk4,::hscript::Token_obj::TSemicolon_dyn() )) {
HXLINE( 653)				e3 = null();
            			}
            			else {
...
HXDLIN( 692)				if (::hx::IsPointerNotEq( t5,::hscript::Token_obj::TBrOpen_dyn() )) {
...
HXDLIN( 734)									if (::hx::IsPointerNotEq( t6,::hscript::Token_obj::TDoubleDot_dyn() )) {
...
HXDLIN( 677)				if (!(__hxcpp_enum_eq(t7,::hscript::Token_obj::TId(HX_("catch",3b,7c,21,41))))) {
HXLINE( 677)					this->unexpected(t7);
            				}
            			}
HXLINE( 678)			{
HXLINE( 678)				 ::hscript::Token t8 = this->token();
HXDLIN( 678)				if (::hx::IsPointerNotEq( t8,::hscript::Token_obj::TPOpen_dyn() )) {
...
HXDLIN( 680)				if (::hx::IsPointerNotEq( t9,::hscript::Token_obj::TDoubleDot_dyn() )) {
...
HXDLIN( 685)				if (!(__hxcpp_enum_eq(t11,::hscript::Token_obj::TId(HX_("Dynamic",5f,c7,66,03))))) {
HXLINE( 685)					this->unexpected(t11);
            				}
            			}
HXLINE( 686)			{
HXLINE( 686)				 ::hscript::Token t12 = this->token();
HXDLIN( 686)				if (::hx::IsPointerNotEq( t12,::hscript::Token_obj::TPClose_dyn() )) {
...
HXDLIN( 603)			if (::hx::IsPointerEq( tk6,::hscript::Token_obj::TDoubleDot_dyn() )) {
...
HXLINE( 608)			if (__hxcpp_enum_eq(tk6,::hscript::Token_obj::TOp(HX_("=",3d,00,00,00)))) {
...
HXLINE( 778)									::String i2 = _hx_tmp1->_hx_getString(0);
...
HXDLIN( 801)						if (::hx::IsPointerNotEq( t1,::hscript::Token_obj::TBkClose_dyn() )) {
...
HXDLIN( 805)						if (::hx::IsPointerNotEq( t2,::hscript::Token_obj::TDoubleDot_dyn() )) {
...
HXLINE( 953)						 ::hscript::CType t1 = this->parseType();
HXLINE( 954)						 ::hscript::Token _g = this->token();
HXDLIN( 954)						if (::hx::IsNull( _g )) {
HXLINE( 966)							 ::hscript::Token t2 = _g;
HXDLIN( 966)							return this->unexpected(t2);
            						}
            						else {
HXLINE( 954)							switch((int)(_g->_hx_getIndex())){
            								case (int)5: {
HXLINE( 965)									return this->parseTypeNext(::hscript::CType_obj::CTParent(t1));
            								}
            								break;
            								case (int)9: {
HXLINE( 956)									::Array< ::Dynamic> args = ::Array_obj< ::Dynamic>::__new(1)->init(0,t1);
HXLINE( 958)									do {
HXLINE( 959)										args->push(this->parseType());
            									} while(this->maybe(::hscript::Token_obj::TComma_dyn()));
;
HXLINE( 962)									{
HXLINE( 962)										 ::hscript::Token t3 = this->token();
HXDLIN( 962)										if (::hx::IsPointerNotEq( t3,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 962)											this->unexpected(t3);
            										}
            									}
HXLINE( 963)									return withReturn(args);
            								...
            								break;
            								default:{
HXLINE( 966)									 ::hscript::Token t4 = _g;
HXDLIN( 966)									return this->unexpected(t4);
            								}
            							}
            						}
            					}
...
HXLINE( 937)						switch((int)(a->_hx_getIndex())){
            							case (int)2: {
HXLINE( 938)								::String _g1 = a->_hx_getString(0);
HXLINE( 937)								if (::hx::IsNull( b )) {
HXLINE( 953)									 ::hscript::CType t5 = this->parseType();
HXLINE( 954)									 ::hscript::Token _g2 = this->token();
HXDLIN( 954)									if (::hx::IsNull( _g2 )) {
HXLINE( 966)										 ::hscript::Token t6 = _g2;
HXDLIN( 966)										return this->unexpected(t6);
            									}
            									else {
HXLINE( 954)										switch((int)(_g2->_hx_getIndex())){
            											case (int)5: {
HXLINE( 965)												return this->parseTypeNext(::hscript::CType_obj::CTParent(t5));
            											}
            											break;
            											case (int)9: {
HXLINE( 956)												::Array< ::Dynamic> args1 = ::Array_obj< ::Dynamic>::__new(1)->init(0,t5);
HXLINE( 958)												do {
...
HXDLIN( 962)													if (::hx::IsPointerNotEq( t7,::hscript::Token_obj::TPClose_dyn() )) {
...
HXLINE( 963)												return withReturn(args1);
            											...
            											break;
            											default:{
HXLINE( 966)												 ::hscript::Token t8 = _g2;
...
HXLINE( 940)										::Array< ::Dynamic> _g3 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 940)										{
HXLINE( 940)											int _g4 = 0;
HXDLIN( 940)											::Array< ::Dynamic> _g5 = this->parseFunctionArgs();
HXDLIN( 940)											while((_g4 < _g5->length)){
HXLINE( 940)												 ::Dynamic arg = _g5->__get(_g4);
HXDLIN( 940)												_g4 = (_g4 + 1);
HXLINE( 941)												{
HXLINE( 941)													 ::hscript::Expr _g6 = arg->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic);
HXLINE( 942)													if (::hx::IsNotNull( _g6 )) {
HXLINE( 943)														 ::hscript::Expr v1 = _g6;
...
HXDLIN( 947)												_g3->push(::hscript::CType_obj::CTNamed( ::Dynamic(arg->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)),_hx_tmp));
            											}
            										}
HXLINE( 940)										::Array< ::Dynamic> args2 = _g3;
HXLINE( 950)										return withReturn(args2);
            									}
            									else {
HXLINE( 953)										 ::hscript::CType t9 = this->parseType();
HXLINE( 954)										 ::hscript::Token _g7 = this->token();
HXDLIN( 954)										if (::hx::IsNull( _g7 )) {
HXLINE( 966)											 ::hscript::Token t10 = _g7;
HXDLIN( 966)											return this->unexpected(t10);
            										}
            										else {
HXLINE( 954)											switch((int)(_g7->_hx_getIndex())){
            												case (int)5: {
HXLINE( 965)													return this->parseTypeNext(::hscript::CType_obj::CTParent(t9));
            												}
            												break;
            												case (int)9: {
HXLINE( 956)													::Array< ::Dynamic> args3 = ::Array_obj< ::Dynamic>::__new(1)->init(0,t9);
HXLINE( 958)													do {
HXLINE( 959)														args3->push(this->parseType());
            													} while(this->maybe(::hscript::Token_obj::TComma_dyn()));
;
HXLINE( 962)													{
HXLINE( 962)														 ::hscript::Token t11 = this->token();
HXDLIN( 962)														if (::hx::IsPointerNotEq( t11,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 962)															this->unexpected(t11);
            														}
            													}
HXLINE( 963)													return withReturn(args3);
            												}
            												break;
            												default:{
HXLINE( 966)													 ::hscript::Token t12 = _g7;
HXDLIN( 966)													return this->unexpected(t12);
            												}
            											}
            										}
            									}
            							...
            							break;
            							case (int)5: {
HXLINE( 940)								::Array< ::Dynamic> _g8 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 940)								{
HXLINE( 940)									int _g9 = 0;
HXDLIN( 940)									::Array< ::Dynamic> _g10 = this->parseFunctionArgs();
HXDLIN( 940)									while((_g9 < _g10->length)){
HXLINE( 940)										 ::Dynamic arg1 = _g10->__get(_g9);
HXDLIN( 940)										_g9 = (_g9 + 1);
HXLINE( 941)										{
HXLINE( 941)											 ::hscript::Expr _g11 = arg1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic);
HXLINE( 942)											if (::hx::IsNotNull( _g11 )) {
HXLINE( 943)												 ::hscript::Expr v2 = _g11;
HXLINE( 944)												if (!(this->resumeErrors)) {
HXLINE( 944)													HX_STACK_DO_THROW(::hscript::Error_obj::ECustom(HX_("Default values not allowed in function types",28,46,7a,e6)));
            												}
            											}
...
HXDLIN( 947)										_g8->push(::hscript::CType_obj::CTNamed( ::Dynamic(arg1->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)),_hx_tmp1));
            									}
            								}
HXLINE( 940)								::Array< ::Dynamic> args4 = _g8;
HXLINE( 950)								return withReturn(args4);
            							}
            							break;
            							default:{
HXLINE( 953)								 ::hscript::CType t13 = this->parseType();
HXLINE( 954)								 ::hscript::Token _g12 = this->token();
HXDLIN( 954)								if (::hx::IsNull( _g12 )) {
HXLINE( 966)									 ::hscript::Token t14 = _g12;
HXDLIN( 966)									return this->unexpected(t14);
            								}
            								else {
HXLINE( 954)									switch((int)(_g12->_hx_getIndex())){
            										case (int)5: {
HXLINE( 965)											return this->parseTypeNext(::hscript::CType_obj::CTParent(t13));
            										}
            										break;
            										case (int)9: {
HXLINE( 956)											::Array< ::Dynamic> args5 = ::Array_obj< ::Dynamic>::__new(1)->init(0,t13);
HXLINE( 958)											do {
HXLINE( 959)												args5->push(this->parseType());
            											} while(this->maybe(::hscript::Token_obj::TComma_dyn()));
;
HXLINE( 962)											{
HXLINE( 962)												 ::hscript::Token t15 = this->token();
HXDLIN( 962)												if (::hx::IsPointerNotEq( t15,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 962)													this->unexpected(t15);
            												}
            											}
HXLINE( 963)											return withReturn(args5);
            										}
            										break;
            										default:{
HXLINE( 966)											 ::hscript::Token t16 = _g12;
HXDLIN( 966)											return this->unexpected(t16);
            										}
            									}
            								}
            							}
...
HXLINE( 974)							switch((int)(t->_hx_getIndex())){
            								case (int)2: {
HXLINE( 982)									::String _g13 = t->_hx_getString(0);
HXDLIN( 982)									if ((_g13 == HX_("var",e7,de,59,00))) {
HXLINE( 977)										::String name = this->getIdent();
HXLINE( 978)										{
HXLINE( 978)											 ::hscript::Token t17 = this->token();
HXDLIN( 978)											if (::hx::IsPointerNotEq( t17,::hscript::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 978)												this->unexpected(t17);
            											}
            										}
...
HXLINE( 981)										{
HXLINE( 981)											 ::hscript::Token t18 = this->token();
HXDLIN( 981)											if (::hx::IsPointerNotEq( t18,::hscript::Token_obj::TSemicolon_dyn() )) {
HXLINE( 981)												this->unexpected(t18);
            											}
            										}
            									}
            									else {
HXLINE( 982)										::String name1 = _g13;
HXDLIN( 982)										{
HXLINE( 983)											{
HXLINE( 983)												 ::hscript::Token t19 = this->token();
HXDLIN( 983)												if (::hx::IsPointerNotEq( t19,::hscript::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 983)													this->unexpected(t19);
            												}
            											}
...
HXDLIN(1147)				if (::hx::IsPointerNotEq( t1,::hscript::Token_obj::TBrOpen_dyn() )) {
...
HXLINE(1111)				if (::hx::IsPointerNotEq( t2,::hscript::Token_obj::TDot_dyn() )) {
HXLINE(1112)					{
...
HXDLIN(1125)				if (::hx::IsPointerNotEq( t3,::hscript::Token_obj::TSemicolon_dyn() )) {
...
HXDLIN(1104)				if (::hx::IsPointerNotEq( t4,::hscript::Token_obj::TSemicolon_dyn() )) {
...
HXDLIN(1164)				if (!(__hxcpp_enum_eq(t5,::hscript::Token_obj::TOp(HX_("=",3d,00,00,00))))) {
...
HXDLIN(1226)						if (::hx::IsPointerNotEq( t2,::hscript::Token_obj::TSemicolon_dyn() )) {
...
HXDLIN(1230)						if (::hx::IsPointerNotEq( t3,::hscript::Token_obj::TSemicolon_dyn() )) {
...
HXLINE(1280)								::String x = ::String::fromCharCode(c1);
...
HXLINE(1279)							::String x1 = ::String::fromCharCode(c1);
HXDLIN(1279)							if (::hx::IsNotNull( b->charBuf )) {
HXLINE(1279)								b->flush();
            							}
HXDLIN(1279)							if (::hx::IsNull( b->b )) {
HXLINE(1279)								b->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            							}
            							else {
HXLINE(1279)								::Array< ::String > b2 = b->b;
HXDLIN(1279)								b2->push(::Std_obj::string(x1));
            							}
            						}
            						else {
...
HXLINE(1583)					 ::hscript::Expr e11 = _g;
...
HXLINE(1585)					 ::hscript::Expr e12 = _g;
HXDLIN(1585)					 ::hscript::Expr e21 = _g1;
...
HXLINE(1589)					return false;
            			...
            			break;
            			case (int)7: {
HXLINE(1579)				bool _g2 = e->_hx_getBool(1);
