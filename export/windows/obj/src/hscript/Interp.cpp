...
HXLINE( 141)				v = this->set(this->expr(e),f,v);
            			...
            			break;
            			case (int)16: {
HXLINE( 142)				 ::hscript::Expr e3 = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 176)					v = this->set(obj,f,v);
            			...
            			break;
            			case (int)16: {
HXLINE( 177)				 ::hscript::Expr e3 = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 217)				return v1;
            			...
            			break;
            			case (int)16: {
HXLINE( 218)				 ::hscript::Expr e2 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 261)				switch((int)(e11->_hx_getIndex())){
            					case (int)0: {
...
HXLINE( 263)						HX_STACK_DO_THROW(HX_("Invalid continue",d0,6a,b7,3f));
            					...
            					break;
            					case (int)2: {
HXLINE( 265)						 ::Dynamic v1 = this->returnValue;
HXLINE( 266)						this->returnValue = null();
HXLINE( 267)						return v1;
            					}
            					break;
            				}
            			}
...
HXLINE( 258)				if (::Std_obj::isOfType(_g->value,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE( 260)					 ::hscript::_Interp::Stop e11 = _g->value;
HXLINE( 261)					switch((int)(e11->_hx_getIndex())){
            						case (int)0: {
HXLINE( 262)							HX_STACK_DO_THROW(HX_("Invalid break",b6,ee,24,9d));
            						}
...
HXDLIN( 341)					while((_g1 < exprs->length)){
HXLINE( 341)						 ::hscript::Expr e3 = exprs->__get(_g1).StaticCast<  ::hscript::Expr >();
HXDLIN( 341)						_g1 = (_g1 + 1);
...
HXLINE( 344)				return v1;
            			...
            			break;
            			case (int)5: {
HXLINE( 345)				 ::hscript::Expr e4 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 345)				::String f1 = e->_hx_getString(1);
...
HXDLIN( 347)				 ::hscript::Expr e21 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 350)				return fop(e11,e21);
            			...
            			break;
            			case (int)7: {
HXLINE( 351)				::String op1 = e->_hx_getString(0);
HXDLIN( 351)				bool prefix = e->_hx_getBool(1);
HXDLIN( 351)				 ::hscript::Expr e6 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 368)					HX_STACK_DO_THROW(e7);
            			...
            			break;
            			case (int)8: {
HXLINE( 370)				 ::hscript::Expr e8 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 372)					while((_g2 < params->length)){
HXLINE( 372)						 ::hscript::Expr p = params->__get(_g2).StaticCast<  ::hscript::Expr >();
HXDLIN( 372)						_g2 = (_g2 + 1);
HXLINE( 373)						args->push(this->expr(p));
            					}
            				}
HXLINE( 375)				if ((e8->_hx_getIndex() == 5)) {
HXLINE( 376)					 ::hscript::Expr e9 = e8->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 376)					::String f2 = e8->_hx_getString(1);
...
HXDLIN( 383)				 ::hscript::Expr e22 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 384)						return this->expr(e22);
            			...
            			break;
            			case (int)10: {
HXLINE( 385)				 ::hscript::Expr econd1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 385)				 ::hscript::Expr e13 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 386)				this->whileLoop(econd1,e13);
HXLINE( 387)				return null();
            			}
            			break;
            			case (int)11: {
HXLINE( 391)				::String v2 = e->_hx_getString(0);
HXDLIN( 391)				 ::hscript::Expr it = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 391)				 ::hscript::Expr e14 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 411)					if ((f != params1->length)) {
...
HXDLIN( 415)							HX_STACK_DO_THROW(e);
            						}
...
HXLINE( 421)						{
HXLINE( 421)							int _g = 0;
HXDLIN( 421)							while((_g < params1->length)){
HXLINE( 421)								 ::Dynamic p = params1->__get(_g);
HXDLIN( 421)								_g = (_g + 1);
...
HXDLIN( 435)						int _g2 = params1->length;
HXDLIN( 435)						while((_g1 < _g2)){
HXLINE( 435)							_g1 = (_g1 + 1);
HXDLIN( 435)							int i = (_g1 - 1);
...
HXDLIN( 441)								 ::Dynamic e1 = _g3;
HXLINE( 442)								me->locals = old;
HXLINE( 443)								me->depth = depth;
HXLINE( 447)								HX_STACK_DO_THROW(e1);
            							}
            							else {
            								HX_STACK_DO_THROW(_hx_e);
            							}
...
HXLINE( 401)				 ::hscript::CType _g3 = e->_hx_getObject(3).StaticCast<  ::hscript::CType >();
...
HXDLIN( 405)					while((_g4 < params1->length)){
HXLINE( 405)						 ::Dynamic p1 = params1->__get(_g4);
HXDLIN( 405)						_g4 = (_g4 + 1);
...
HXLINE( 460)						this->variables->set(name,f4);
            					}
            					else {
...
HXLINE( 469)				return f4;
            			...
            			break;
            			case (int)15: {
HXLINE( 398)				 ::hscript::Expr e15 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 399)				 ::Dynamic _hx_tmp2;
HXDLIN( 399)				if (::hx::IsNull( e15 )) {
HXLINE( 399)					_hx_tmp2 = null();
            				}
            				else {
HXLINE( 399)					_hx_tmp2 = this->expr(e15);
            				}
HXDLIN( 399)				this->returnValue = _hx_tmp2;
HXLINE( 400)				HX_STACK_DO_THROW(::hscript::_Interp::Stop_obj::SReturn_dyn());
            			}
            			break;
            			case (int)16: {
HXLINE( 512)				 ::hscript::Expr e16 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 512)				 ::hscript::Expr index = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 513)				 ::Dynamic arr = this->expr(e16);
...
HXLINE( 471)					 ::hscript::Expr _g5 = arr1->__get(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 471)					if ((_g5->_hx_getIndex() == 6)) {
HXLINE( 471)						 ::hscript::Expr _g6 = _g5->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 471)						 ::hscript::Expr _g7 = _g5->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 471)						if ((_g5->_hx_getString(0) == HX_("=>",61,35,00,00))) {
...
HXDLIN( 478)						while((_g8 < arr1->length)){
HXLINE( 478)							 ::hscript::Expr e17 = arr1->__get(_g8).StaticCast<  ::hscript::Expr >();
HXDLIN( 478)							_g8 = (_g8 + 1);
HXLINE( 479)							if ((e17->_hx_getIndex() == 6)) {
HXLINE( 480)								if ((e17->_hx_getString(0) == HX_("=>",61,35,00,00))) {
HXLINE( 480)									 ::hscript::Expr eKey = e17->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 480)									 ::hscript::Expr eValue = e17->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 480)									{
...
HXLINE( 500)					{
HXLINE( 500)						int _g9 = 0;
HXDLIN( 500)						int _g10 = keys->get_length();
HXDLIN( 500)						while((_g9 < _g10)){
HXLINE( 500)							_g9 = (_g9 + 1);
HXDLIN( 500)							int n1 = (_g9 - 1);
...
HXDLIN( 507)						while((_g11 < arr1->length)){
HXLINE( 507)							 ::hscript::Expr e18 = arr1->__get(_g11).StaticCast<  ::hscript::Expr >();
HXDLIN( 507)							_g11 = (_g11 + 1);
HXLINE( 508)							a->push(this->expr(e18));
            						}
            					}
HXLINE( 510)					return a;
            				}
...
HXDLIN( 521)				::Array< ::Dynamic> params2 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 522)				::cpp::VirtualArray a1 = ::cpp::VirtualArray_obj::__new();
HXLINE( 523)				{
HXLINE( 523)					int _g12 = 0;
HXDLIN( 523)					while((_g12 < params2->length)){
HXLINE( 523)						 ::hscript::Expr e19 = params2->__get(_g12).StaticCast<  ::hscript::Expr >();
HXDLIN( 523)						_g12 = (_g12 + 1);
HXLINE( 524)						a1->push(this->expr(e19));
            					}
            				}
HXLINE( 525)				return this->cnew(cl,a1);
            			...
            			break;
            			case (int)19: {
HXLINE( 526)				 ::hscript::Expr e20 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 527)				HX_STACK_DO_THROW(this->expr(e20));
            			}
            			break;
            			case (int)20: {
HXLINE( 528)				 ::hscript::CType _g13 = e->_hx_getObject(2).StaticCast<  ::hscript::CType >();
HXDLIN( 528)				 ::hscript::Expr e23 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 528)				::String n2 = e->_hx_getString(1);
HXDLIN( 528)				 ::hscript::Expr ecatch = e->_hx_getObject(3).StaticCast<  ::hscript::Expr >();
HXLINE( 529)				int old1 = this->declared->length;
...
HXLINE( 533)					 ::Dynamic v3 = this->expr(e23);
HXLINE( 534)					this->restore(old1);
...
HXLINE( 539)						HX_STACK_DO_THROW(err1);
            					}
            					else if (_hx_e.IsClass<  ::haxe::ValueException >() ){
            						HX_STACK_BEGIN_CATCH
...
HXLINE( 531)						if (::Std_obj::isOfType(_g14->value,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE( 537)							 ::hscript::_Interp::Stop err1 = _g14->value;
HXLINE( 538)							this->inTry = oldTry;
HXLINE( 539)							HX_STACK_DO_THROW(err1);
            						}
            						else {
HXLINE( 531)							HX_STACK_DO_THROW(_g14);
            						}
            					}
...
HXDLIN( 540)						 ::Dynamic err2 = _g15;
HXLINE( 542)						this->restore(old1);
HXLINE( 543)						this->inTry = oldTry;
HXLINE( 545)						::Array< ::Dynamic> _hx_tmp4 = this->declared;
HXDLIN( 545)						_hx_tmp4->push( ::Dynamic(::hx::Anon_obj::Create(2)
...
HXLINE( 553)				{
HXLINE( 553)					int _g16 = 0;
HXDLIN( 553)					while((_g16 < fl->length)){
HXLINE( 553)						 ::Dynamic f5 = fl->__get(_g16);
HXDLIN( 553)						_g16 = (_g16 + 1);
...
HXLINE( 555)				return o;
            			...
            			break;
            			case (int)22: {
HXLINE( 556)				 ::hscript::Expr econd2 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 556)				 ::hscript::Expr e110 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 556)				 ::hscript::Expr e24 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 557)				if (::hx::IsEq( this->expr(econd2),true )) {
HXLINE( 557)					return this->expr(e110);
            				}
            				else {
HXLINE( 557)					return this->expr(e24);
            				}
            			}
            			break;
            			case (int)23: {
HXLINE( 558)				 ::hscript::Expr e25 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 559)				 ::Dynamic val = this->expr(e25);
HXLINE( 560)				bool match = false;
HXLINE( 561)				{
HXLINE( 561)					int _g17 = 0;
HXDLIN( 561)					while((_g17 < cases->length)){
HXLINE( 561)						 ::Dynamic c1 = cases->__get(_g17);
HXDLIN( 561)						_g17 = (_g17 + 1);
HXLINE( 562)						{
HXLINE( 562)							int _g18 = 0;
HXDLIN( 562)							::Array< ::Dynamic> _g19 = ( (::Array< ::Dynamic>)(c1->__Field(HX_("values",e2,03,b7,4f),::hx::paccDynamic)) );
HXDLIN( 562)							while((_g18 < _g19->length)){
HXLINE( 562)								 ::hscript::Expr v5 = _g19->__get(_g18).StaticCast<  ::hscript::Expr >();
HXDLIN( 562)								_g18 = (_g18 + 1);
...
HXLINE( 574)				return val;
            			...
            			break;
            			case (int)24: {
HXLINE( 388)				 ::hscript::Expr econd3 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 388)				 ::hscript::Expr e26 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 389)				this->doWhileLoop(econd3,e26);
HXLINE( 390)				return null();
            			}
            			break;
            			case (int)25: {
HXLINE( 575)				::String _g20 = e->_hx_getString(0);
HXDLIN( 575)				::Array< ::Dynamic> _g21 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 575)				 ::hscript::Expr e27 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 576)				return this->expr(e27);
            			}
            			break;
            			case (int)26: {
HXLINE( 577)				 ::hscript::CType _g22 = e->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 577)				 ::hscript::Expr e28 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 578)				return this->expr(e28);
            			}
            			break;
            		}
...
HXLINE( 587)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::hscript::_Interp::Stop >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::hscript::_Interp::Stop err1 = _hx_e;
HXLINE( 589)					switch((int)(err1->_hx_getIndex())){
            						case (int)0: {
HXLINE( 591)							goto _hx_goto_66;
            						...
            						break;
            						case (int)2: {
HXLINE( 592)							HX_STACK_DO_THROW(err1);
            						}
            						break;
            					}
            				}
...
HXLINE( 586)					if (::Std_obj::isOfType(_g->value,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE( 588)						 ::hscript::_Interp::Stop err1 = _g->value;
HXLINE( 589)						switch((int)(err1->_hx_getIndex())){
            							case (int)0: {
HXLINE( 591)								goto _hx_goto_66;
            							}
...
HXLINE( 604)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::hscript::_Interp::Stop >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::hscript::_Interp::Stop err1 = _hx_e;
HXLINE( 606)					switch((int)(err1->_hx_getIndex())){
            						case (int)0: {
HXLINE( 608)							goto _hx_goto_68;
            						...
            						break;
            						case (int)2: {
HXLINE( 609)							HX_STACK_DO_THROW(err1);
            						}
            						break;
            					}
            				}
...
HXLINE( 603)					if (::Std_obj::isOfType(_g->value,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE( 605)						 ::hscript::_Interp::Stop err1 = _g->value;
HXLINE( 606)						switch((int)(err1->_hx_getIndex())){
            							case (int)0: {
HXLINE( 608)								goto _hx_goto_68;
            							}
...
HXDLIN( 622)			HX_STACK_DO_THROW(e);
            		}
HXLINE( 623)		return v;
            	}
...
HXLINE( 633)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::hscript::_Interp::Stop >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::hscript::_Interp::Stop err1 = _hx_e;
HXLINE( 635)					switch((int)(err1->_hx_getIndex())){
            						case (int)0: {
HXLINE( 637)							goto _hx_goto_71;
            						...
            						break;
            						case (int)2: {
HXLINE( 638)							HX_STACK_DO_THROW(err1);
            						}
            						break;
            					}
            				}
...
HXLINE( 632)					if (::Std_obj::isOfType(_g->value,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE( 634)						 ::hscript::_Interp::Stop err1 = _g->value;
HXLINE( 635)						switch((int)(err1->_hx_getIndex())){
            							case (int)0: {
HXLINE( 637)								goto _hx_goto_71;
            							}
