...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Verxial", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Verxial", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Verxial";
		app.meta["name"] = "Verxial";
